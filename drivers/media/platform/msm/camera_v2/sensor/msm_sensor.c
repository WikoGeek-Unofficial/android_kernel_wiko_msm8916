...
int msm_sensor_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	int rc = 0;
	uint16_t chipid = 0;
       uint16_t mid = 0; //Line<REQ><JABAL-1500><20150804>Add camera for L5261;xiongdajun
	struct msm_camera_i2c_client *sensor_i2c_client;
	struct msm_camera_slave_info *slave_info;
	const char *sensor_name;
   ...
   if((!strncmp(s_ctrl->sensordata->sensor_name, "ov5648_q5v22e_darling_l5261", sizeof("ov5648_q5v22e_darling_l5261"))) ||
      (!strncmp(s_ctrl->sensordata->sensor_name, "ov5648_q5v22e_qtech_l5261", sizeof("ov5648_q5v22e_qtech_l5261"))) ||
      (!strncmp(s_ctrl->sensordata->sensor_name, "ov5648_q5v22e_darling_l5421", sizeof("ov5648_q5v22e_darling_l5421"))) ||
      (!strncmp(s_ctrl->sensordata->sensor_name, "ov5648_q5v22e_qtech_l5421", sizeof("ov5648_q5v22e_qtech_l5421"))))
        {
             ...
             pr_err("%s: mid is %d:\n", __func__, mid);
             //Begin<REQ><><20150804>read camera mid2 of ov5648;xiongdajun
             if((mid != 0x05) && (mid != 0x06))
                {
                rc = sensor_i2c_client->i2c_func_tbl->i2c_read(
        		sensor_i2c_client, 0x3d0e,
        		&mid, MSM_CAMERA_I2C_BYTE_DATA);
                pr_err("%s: mid is %d:\n", __func__, mid);
                }
             //END<REQ><><20150804>read camera mid2 of ov5648;xiongdajun
             if((!strncmp(s_ctrl->sensordata->sensor_name, "ov5648_q5v22e_darling_l5261", sizeof("ov5648_q5v22e_darling_l5261"))) ||
                (!strncmp(s_ctrl->sensordata->sensor_name, "ov5648_q5v22e_darling_l5421", sizeof("ov5648_q5v22e_darling_l5421"))))
                {
                    if(mid == 5)
                       pr_err("mid of darling's camera is 5\n");
                    else
                        return -ENODEV;
             }
             else if((!strncmp(s_ctrl->sensordata->sensor_name, "ov5648_q5v22e_qtech_l5261", sizeof("ov5648_q5v22e_qtech_l5261"))) ||
                    (!strncmp(s_ctrl->sensordata->sensor_name, "ov5648_q5v22e_qtech_l5421", sizeof("ov5648_q5v22e_qtech_l5421"))))
                {
                    if(mid == 6)
                       pr_err("mid of Qtech's camera is 6\n");
                    else
                        return -ENODEV;
             }
   ...
   //END<REQ><JABAL-1500><20150804>Add camera for L5261;xiongdajun
	...
	CDBG("%s:  is_front_camera = %d  s_ctrl->id = %d:\n", __func__,
		is_front_camera , s_ctrl->id );
